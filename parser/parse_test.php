<?php
# DONE clean the data
$raw_data = file_get_contents("../raw_data_test/2014_2.html");
...
file_put_contents('../parsed_data_text/2014_2_data_test.txt', print_r($super_data, true));
file_put_contents('../parsed_data_json/2014_2_data_test.json', json_encode($super_data));
